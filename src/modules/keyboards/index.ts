...
export default function(language: Languages, keyboard_name: KeyboardName, resize_keyboard: boolean = true) {
    let keyboard = Markup.keyboard(keyboard_translation(language, keyboards[keyboard_name]))
    if (resize_keyboard)
